...
assert.equal(nextTargetFromSpec("2–4 sec",spec,block.kind),"2–5 sec");
assert.equal(nextTargetFromSpec("4–5 sec",spec,block.kind),"4–6 sec");
...
assert.equal(nextTargetFromSpec("6–10 sec",assistedSpec,assisted.kind),"6–11 sec");
