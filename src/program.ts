...
export const PROGRAM:Record<DayKey,DayProgram>={
 Monday:{title:"PUSH A",subtitle:"Pike strength • Push volume",warmup:pushWarmup,blocks:[
  ...
  {id:"pushup-volume",kind:"PERFORMANCE",trainingRole:"hypertrophy",priority:"primary",name:"Push-up",detail:"3 × 12–20 • RIR 1–2 • controlled full ROM",sets:3,target:"12–20",rest:120,previousMode:"reps"},
  {id:"dips-volume-a",kind:"PERFORMANCE",trainingRole:"hypertrophy",priority:"primary",name:"Dips",detail:"3 × 10–18 • RIR 1–2 • controlled depth",sets:3,target:"10–18",rest:150,previousMode:"reps"},
 ...
 Tuesday:{title:"PULL A",subtitle:"Front Touch • High Pull • Pull-up volume",warmup:pullWarmup,blocks:[
  {id:"touch",kind:"SKILL_STATIC",trainingRole:"skill",priority:"primary",name:"Front Touch",detail:"4 × 2–4 sec • stop before shape breaks",sets:4,target:"2–4 sec",rest:240,countdown:true,previousMode:"seconds"},
  {id:"touch-band",kind:"VOLUME_SKILL",trainingRole:"skill",priority:"secondary",name:"Assisted Front Touch",detail:"3 × 6–10 sec • use the lightest band that preserves the touch pattern",sets:3,target:"6–10 sec",rest:180,bandOptions:["Blue 15–25 lb","Purple 25–40 lb"],defaultBand:"Purple 25–40 lb",countdown:true,previousMode:"seconds"},
 ...
 Friday:{title:"PUSH C",subtitle:"Long sets • Close grip • Push-up + dip density",warmup:pushWarmup,blocks:[
  {id:"pushup-long",kind:"PERFORMANCE",trainingRole:"hypertrophy",priority:"secondary",name:"Push-up Long Set",detail:"1 × 25–40 • stop around RIR 2–3 • progress total reps without chasing failure",sets:1,target:"25–40",rest:180,previousMode:"reps"},
  {id:"dips-long",kind:"PERFORMANCE",trainingRole:"hypertrophy",priority:"secondary",name:"Dips Long Set",detail:"1 × 25–40 • stop around RIR 2 • dips are a strength; keep ROM consistent",sets:1,target:"25–40",rest:180,previousMode:"reps"},
