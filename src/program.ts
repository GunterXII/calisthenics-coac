...
export const PROGRESSION_SPECS:Record<string,ProgressionRegistryEntry> = {
  ...
  "pullup": {
    ...
    "rule": "10-min EMOM reaches coach upper range with <15% drop-off",
  ...
  "close-chin": {
    ...
    "rule": "10-min EMOM reaches 10/min with stable ROM",
  ...
  "close-pull": {
    ...
    "rule": "10-min EMOM reaches 9/min with <15% drop-off",
